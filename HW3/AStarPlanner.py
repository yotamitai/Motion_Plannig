    ...
    def Plan(self, start_config, goal_config):
        ...
        def get_neighbors_and_distances(node):
            ...
            neighbors = [n for n in neighbors if
                         self.planning_env.state_validity_checker(n)]  # filter out non valid nodes
        ...
        while open_list:
            ...
            if current == sg:
                ...
                print(f'w = {self.w}; num of nodes opened: {count}; search time: {dt}; plan cost: {plan_cost}')
            ...
            for child, cost in zip(neighbors, distances):
                if (gscore_dict[current] + cost) < gscore_dict[child]:
                    ...
                    fscore_dict[child] = self.w * _get_h(child) + gscore_dict[child]
